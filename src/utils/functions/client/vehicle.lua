slyyCore.utils.getVehicleProperties = function(vehicle)
    ...
    return {
        ...
        plate = slyyCore.utils.trim(GetVehicleNumberPlateText(vehicle)),
        plateIndex = GetVehicleNumberPlateTextIndex(vehicle),

        bodyHealth = slyyCore.utils.round(GetVehicleBodyHealth(vehicle), 1),
        engineHealth = slyyCore.utils.round(GetVehicleEngineHealth(vehicle), 1),
        tankHealth = slyyCore.utils.round(GetVehiclePetrolTankHealth(vehicle), 1),

        fuelLevel = slyyCore.utils.round(GetVehicleFuelLevel(vehicle), 1),
        dirtLevel = slyyCore.utils.round(GetVehicleDirtLevel(vehicle), 1),
        color1 = colorPrimary,
...
slyyCore.utils.setVehicleProperties = function(vehicle, props)
    if not DoesEntityExist(vehicle) then
        return
    end
    local colorPrimary, colorSecondary = GetVehicleColours(vehicle)
